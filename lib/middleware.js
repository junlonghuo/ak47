...
//	var remove = pre.removeTag('script', '/alipay.js"');
    ...
    return function (req, res, next) {
        ...
        if (file === '/qr') {
            ...
            var scheme = 'alipays://platformapi/startapp?appId=20000067&url=' + _path;
            ...
            var table = '<table>';
            table += '<tr><td colspan=2><label>' + host + '</label><input id="index" type="text" value="' + _index + '"/><button id="remake">确定</button></td></tr>';
